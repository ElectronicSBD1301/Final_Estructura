...
public class AlgoritmoDijkstra {
    // M�todo para encontrar el camino m�s corto usando el algoritmo de Dijkstra
    public ArrayList<Integer> calcularCamino(Grafo grafo, int origen, int destino) {
        ...
        Arrays.fill(padre, -1); //Se llena de -1 indicando que no se ha encontrado un camino (a�n).
        distancias[origen] = 0;
    ...
    // M�todo auxiliar para encontrar el v�rtice con la distancia m�nima
